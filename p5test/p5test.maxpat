...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 192.5, 176.0, 80.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 203.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "draw"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 78.0, 290.0, 252.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 249.0, 67.0, 22.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "p5test.js",
				"bootpath" : "~/Documents/Generative_Design_MaxMSP/p5test",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
