    ...
    (function () {
        ...
        var Color = function () {
            ...
            _createClass(Color, [{
                 ...
                 */
                value: function setRGB(red, green, blue, rounded) {
                ...
                key: 'setRGBA',
                value: function setRGBA(red, green, blue, alpha, rounded) {
                ...
                key: 'setRGBArray',
                value: function setRGBArray(color, rounded) {
                ...
                key: 'setHSL',
                value: function setHSL(hue, saturation, lightness, rounded) {
                ...
                key: 'setHSLA',
                value: function setHSLA(hue, saturation, lightness, alpha, rounded) {
                ...
                key: 'setHSLArray',
                value: function setHSLArray(color, rounded) {
                ...
                key: 'setRed',
                value: function setRed(value, rounded) {
                ...
                key: 'setGreen',
                value: function setGreen(value, rounded) {
                ...
                key: 'setBlue',
                value: function setBlue(value, rounded) {
                ...
                key: 'setHue',
                value: function setHue(value, rounded) {
                ...
                key: 'setSaturation',
                value: function setSaturation(value, rounded) {
                ...
                key: 'setLightness',
                value: function setLightness(value, rounded) {
                ...
                key: 'getRGBA',
                value: function getRGBA(round) {
                    var result = this.getRGB(round);
                ...
                key: 'getHSLA',
                value: function getHSLA(round) {
                    var result = this.getHSL(round);
                ...
                key: 'getSaturation',
                value: function getSaturation(round) {
                ...
                key: 'getLightness',
                value: function getLightness(round) {
                ...
                key: 'getContrast',
                value: function getContrast(color) {
                    var lum1 = this.getLuminance() + 0.05,
                ...
                key: 'toKeyword',
                value: function toKeyword(findClosest, useExtended) {
                    var color = void 0,
                        keywords = void 0,
                        match = void 0,
                        margin = void 0,
                        componentMargin = void 0,
                        rgb = void 0,
                        keyword = void 0,
                        diff = void 0,
                        componentDiff = void 0,
                        maxComponentDiff = void 0,
                        i = void 0;
                ...
                key: 'toIEHex',
                value: function toIEHex(compress) {
                ...
                key: 'toRGBString',
                value: function toRGBString(compress, ignoreAlpha, alphaPrecision) {
                ...
                key: 'toHSLString',
                value: function toHSLString(compress, ignoreAlpha, alphaPrecision, roundPrecision) {
                    return this.toString({
                        format: 'hsl',
                        compress: compress === void 0 ? false : compress,
                        ignoreAlpha: ignoreAlpha === void 0 ? false : ignoreAlpha,
                 ...
                 * @private
                 */
                value: function _setRGBArray(color, rounded) {
                    if (color.length === 4) {
                ...
                key: '_setHSLArray',
                value: function _setHSLArray(color, rounded) {
                    if (color.length === 4) {
                        this._alpha = color.pop();
                    } else if (color.length !== 3) {
                        return null;
                ...
                key: '_setRGB',
                value: function _setRGB(index, value, rounded) {
                    if (this._rgb === null) {
                        this._convertToRGB();
                    }
                ...
                key: '_setHSL',
                value: function _setHSL(index, value, rounded) {
                    if (this._hsl === null) {
                        this._convertToHSL();
                    }
                ...
                key: '_getRGB',
                value: function _getRGB(index, round) {
                    if (this._rgb === null) {
                        this._convertToRGB();
                    }
                    if (round && this._rgbRounded === null) {
                ...
                key: '_getHSL',
                value: function _getHSL(index, round) {
                    if (this._hsl === null) {
                        this._convertToHSL();
                    }
                    if (round && this._hslRounded === null) {
                ...
                key: '_roundRGB',
                value: function _roundRGB() {
                    var r = Math.round(this._rgb[0]),
                ...
                key: '_roundHSL',
                value: function _roundHSL() {
                    var h = Math.round(this._hsl[0]),
                ...
                key: '_resetSpaces',
                value: function _resetSpaces(keep) {
                 ...
                 * @private
                 */
                value: function _getHexValue(compress, includeAlpha) {
                    if (this._rgb === null) {
                        this._convertToRGB();
                    }
                    if (this._rgbRounded === null) {
                    ...
                    var result = '#';
                    if (includeAlpha) {
                        var alpha = Math.max(Math.min(Math.round(this._alpha * 255), 255), 0);
                ...
                key: 'fromKeyword',
                value: function fromKeyword(keyword, useExtended) {
                    useExtended = useExtended === void 0 ? true : useExtended;
                    ...
                    var keywords = useExtended ? Keywords.all : Keywords.base;
                ...
                key: '_normalize',
                value: function _normalize(value, max) {
                ...
                key: '_normalizeHue',
                value: function _normalizeHue(value) {
                ...
                key: '_rgb2hsl',
                value: function _rgb2hsl(r, g, b, round) {
                    var c1 = r / 255,
                        c2 = g / 255,
                        c3 = b / 255,
                ...
                key: '_hsl2rgb',
                value: function _hsl2rgb(h, s, l, round) {
                    var lum = void 0,
                        sat = void 0,
                        hue = void 0,
                        m1 = void 0,
                ...
                key: '_equalColors',
                value: function _equalColors(var1, var2) {
                ...
                key: '_compressString',
                value: function _compressString(value) {
                    if (value.slice(0, 1) === '#') {
                        // Compress hex string
