...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 488.0, 37.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 234.5, 222.0, 34.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 137.0, 554.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 171.0, 523.662841999999955, 77.0, 22.0 ],
					"text" : "exportimage"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 61.0, 406.0, 45.0 ],
					"text" : "The color values of the camera's pixels are translated sequentially by a random walker."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 281.0, 222.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 534.0, 77.0, 39.0, 22.0 ],
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 484.5, 77.0, 37.0, 22.0 ],
					"text" : "open"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 77.0, 146.0, 73.0, 22.0 ],
									"text" : "jit.pack 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 77.0, 228.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 451.0, 156.0, 79.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 451.0, 189.0, 163.0, 22.0 ],
					"text" : "jit.matrix cam 3 char 640 480"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 451.0, 123.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 9.0, 406.0, 50.0 ],
					"text" : "Real-time pixel values"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 78.0, 187.0, 248.0, 22.0 ],
					"text" : "jit.world P_4_3_3 @floating 1 @size 640 480"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 488.0, 83.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "P_4_3_3.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 110.0, 155.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 458.0, 77.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 259.0, 265.0, 428.0, 265.0, 428.0, 113.0, 460.5, 113.0 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "P_4_3_3.js",
				"bootpath" : "~/Documents/Max 8/Packages/Generative-Design-Max-MSP/patchers/P_4_Hello_Image/P_4_3_3_Real_time_pixels",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
