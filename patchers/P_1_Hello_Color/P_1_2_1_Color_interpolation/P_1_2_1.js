...
function draw() {
  ...
  for(var y = 0; y < tilecount_y; y++) {
    ...
    for(var x = 0; x < tilecount_x; x++) {
      ...
      var interp_col_HSBA_norm = [interp_col_HSBA.channels[0]/max_hue, interp_col_HSBA.channels[1]/max_saturation, interp_col_HSBA.channels[2]/max_brightness, 1];
...
function lerpcolor(c1, c2, a) {
  ...
  var c = new Color(pc.lerp(col1[0], col2[0], a), pc.lerp(col1[1], col2[1], a), pc.lerp(col1[2], col2[2], a), 255);
  return c;
}
