...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 430.0, 52.0, 22.0 ],
					"text" : "plane -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 179.0, 456.0, 200.0, 200.0 ],
					"rows" : 500
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 51.0, 174.0, 98.0, 33.0 ],
...
,
					"text" : "interpolate shortest",
					"texton" : "interpolate shortest",
					"varname" : "live.text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 274.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 239.0, 174.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 8.0, 591.0, 50.0 ],
					"text" : "Color palettes through interpolation"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 167.0, 79.0, 22.0 ],
					"text" : "loadmess 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 276.0, 98.0, 22.0 ],
					"text" : "pak 10 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 308.0, 98.0, 22.0 ],
					"text" : "setGridXY $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 225.0, 75.0, 22.0 ],
					"text" : "shakecolors"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 225.0, 37.0, 22.0 ],
					"text" : "draw"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 376.5, 333.0, 231.0, 333.0, 231.0, 261.0, 146.5, 261.0 ],
					"source" : [ "obj-22", 0 ]
				}
