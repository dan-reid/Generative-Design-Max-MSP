...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 364.0, 75.0, 22.0 ],
					"text" : "exportimage"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 140.0, 392.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 134.0, 198.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 277.0, 37.0, 22.0 ],
					"text" : "draw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 60.0, 419.0, 241.0, 22.0 ],
					"text" : "jit.gl.videoplane M_4_2 @transform_reset 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 359.0, 69.0, 22.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "M_4_2.js",
				"bootpath" : "~/Documents/Max 8/Packages/Generative-Design-Max-MSP/patchers/M_4_Attractors/M_4_2_Atractor",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
