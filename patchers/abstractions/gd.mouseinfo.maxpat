...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 9.0, 183.0, 50.0 ],
					"text" : "Hello, type"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "P_3_0.js",
				"bootpath" : "~/Developer/Generative_Design_MaxMSP/patchers/P_3_Hello_Type/P_3_0_Hello_type",
				"patcherrelativepath" : "../P_3_Hello_Type/P_3_0_Hello_type",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
