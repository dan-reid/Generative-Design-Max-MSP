...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 53.0, 422.0, 254.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.videoplane P_2_1_1 @transform_reset 2"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "P_2_1_1.js",
				"bootpath" : "~/Documents/Generative_Design_MaxMSP/P_2_Hello_Shape/P_2_1_1_Alignment_in_a_grid",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
