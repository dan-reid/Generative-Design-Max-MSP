...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 357.0, 238.0, 81.0, 22.0 ],
					"text" : "gd.mouseinfo"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 341.0, 365.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Drag within the window to interact."
				}
...
, 			{
				"box" : 				{
					...
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-18", "number", "int", 0, 5, "obj-25", "number", "int", 1, 5, "obj-29", "flonum", "float", 0.449999988079071 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-18", "number", "int", 0, 5, "obj-25", "number", "int", 2, 5, "obj-29", "flonum", "float", 0.75 ]
						}
, 						{
							"number" : 3,
...
, 						{
							"number" : 6,
							"data" : [ 5, "obj-18", "number", "int", 2, 5, "obj-25", "number", "int", 6, 5, "obj-29", "flonum", "float", -0.75 ]
						}
, 						{
							"number" : 7,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.5, 284.0, 37.0, 22.0 ],
					"text" : "draw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.5, 346.0, 103.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 200.0, 384.0, 13.0, 384.0, 13.0, 196.0, 33.5, 196.0 ],
					"order" : 1,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "P_2_1_1_04.js",
				"bootpath" : "~/Documents/Max 8/Packages/Generative-Design-Max-MSP/patchers/P_2_Hello_Shape/P_2_1_1_Alignment_in_a_grid_svg",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
