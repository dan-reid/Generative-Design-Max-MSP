...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.0, 461.0, 75.0, 22.0 ],
					"text" : "exportimage"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 490.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 377.0, 216.0, 81.0, 22.0 ],
					"text" : "m4x.mouseinfo"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.0, 176.0, 363.0, 22.0 ],
					"text" : "jit.world P_3_1_2_02 @floating 1 @size 500 500 @dim 1000 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 410.0, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "P_3_1_2_02.js",
						"parameter_enable" : 0
					}
,
					"text" : "js P_3_1_2_02.js"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 448.5, 264.0, 90.0, 264.0, 90.0, 396.0, 51.5, 396.0 ],
					"source" : [ "obj-14", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 433.0, 264.0, 90.0, 264.0, 90.0, 396.0, 51.5, 396.0 ],
					"source" : [ "obj-14", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 417.5, 291.0, 90.0, 291.0, 90.0, 396.0, 51.5, 396.0 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 402.0, 396.0, 51.5, 396.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "P_3_1_2_02.js",
				"bootpath" : "~/Documents/Max 8/Packages/Generative-Design-Max-MSP/patchers/P_3_Hello_Type/P_3_1_2_02_Text_as_blueprint",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
