...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 9.0, 290.0, 50.0 ],
					"text" : "m4x.noise_seed()"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "noise_seed.example.js",
				"bootpath" : "~/Documents/Max 8/Packages/Generative-Design-Max-MSP/patchers/m4x_reference/noise/m4x.noise_seed",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
