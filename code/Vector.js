function Vector () {
  ...
  if (arguments[0] instanceof Object && arguments[0].constructor.name === 'PClone') {
...
Vector.prototype.cross = function (v) {
  ...
  if (this.PClone) {
    return new Vector(this.PClone, [x, y, z]);
  } else {
...
Vector.prototype.set_mag = function (n) {
...
Vector.prototype.heading = function () {
  ...
  if (this.PClone) return this.PClone.radians(h);
  return h;
};
...
Vector.prototype.rotate = function (a) {
  ...
  if (this.PClone) newHeading = this.PClone.radians(newHeading);
  var mag = this.mag();
...
Vector.prototype.angle_between = function (v) {
  ...
  if (this.PClone) return this.PClone.radians(angle);
  return angle;
};
...
Vector.from_angle = function (angle, length) {
